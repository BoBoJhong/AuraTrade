...
| ID | 標題 | 優先級 | 故事點數 | 狀態 |
|----|------|--------|----------|------|
| US-01 | 即時查看股票價格 | P0 | 5 | 待開發 |
| US-02 | 自定義股票關注清單 | P0 | 3 | 待開發 |
| US-03 | 查看 K 線圖與技術指標 | P0 | 8 | 待開發 |
| US-04 | 自動爬取並分析 Google 新聞 | P0 | 8 | 待開發 |
| US-05 | 分析社群平台情緒 | P1 | 13 | 待開發 |
| US-06 | AI 提供多維度投資建議 | P0 | 13 | 待開發 |
| US-07 | 評估建議的風險等級 | P0 | 5 | 待開發 |
| US-08 | 記錄 AI 決策過程 | P1 | 5 | 待開發 |
| US-09 | 透過 LINE 接收即時通知 | P0 | 8 | 待開發 |
| US-10 | 查看多期報表 | P1 | 8 | 待開發 |
| US-11 | 報表視覺化圖表 | P1 | 8 | 待開發 |
| US-12 | 用戶註冊與登入 | P0 | 8 | 待開發 |
| US-13 | 永久保存歷史數據 | P1 | 3 | 待開發 |
| US-14 | 清楚顯示系統異常 | P0 | 5 | 待開發 |
